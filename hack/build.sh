...
# start
# bin/ocm-controlplane --secure-port 8443 --client-ca-file .ocmconfig/ca.crt --kubeconfig ~/.kube/config --authentication-kubeconfig ~/.kube/config --authorization-kubeconfig ~/.kube/config
